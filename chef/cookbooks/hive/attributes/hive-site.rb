...
default[:hive][:hive_metastore_rawstore_impl] = "org.apache.hadoop.hive.metastore.ObjectStore"

# Comma separated list of URIs of metastore servers. The first server that
# can be connected to will be used.
default[:hive][:hive_metastore_uris] = "file:///var/metastore/metadb/"

# location of default database for the warehouse.
default[:hive][:hive_metastore_warehouse_dir] = "/user/hive/warehouse"
